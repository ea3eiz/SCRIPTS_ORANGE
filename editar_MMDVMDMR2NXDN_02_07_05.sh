...
pas=`grep -n '\<Password\>' /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini`
...
var300port= sed -n $linea22port  /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini;
...
echo "   Valor actual del Password: \33[1;33m${pas#*=}\33[1;37m"
           	          read -p '   Introduce el password que corresponda: ' pas1
                          ...
                          sed -i "$linea Password=$pas1" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
			   read -p 'Intruduce reflector DMR+ al que se conectara (ej:4370) ' opcion
                          ...
                          sed -i "$linea4 Options=StartRef=$opcion;RelinkTime=10;" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  letra1=c
                          linea4=$linea33port$letra1
			  sed -i "$linea4 #Options=StartRef=4370;RelinkTime=10;" /home/orangepi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
esac
done;;
28) echo ""
