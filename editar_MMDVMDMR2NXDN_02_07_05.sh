...
presentar_valor= sed -n $numero_linea_p  /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini; #presenta el valor en pantalla
...
sala=$(awk "NR==50" /home/pi/NXDNClients/NXDNGateway/NXDNGateway.ini)
echo "$sala"
...
do
                          ...
                          sed -i "$linea Local=$dmrac1" /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini
...
do
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "50c Startup=$dmrac1" /home/pi/NXDNClients/NXDNGateway/NXDNGateway.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
