...
clear
            ...
            case $ejecutar1 in
            [sS]* ) echo ""
            #Comprueba si existe el fichero MMDVM.ini
            if [ -f ~/Downloads/MMDVM.ini ];
            then
...
echo "***************************************************"
            ...
            cp -f YSF2DMR.ini_copia_03 ~/YSF2DMR
            cp -f YSF2DMR.ini_copia_04 ~/YSF2DMR
...
echo "\33[1;31m" #color verde
echo "***************************************************"
echo "*     NO TIENES NINGUNA COPIA QUE RESTAURAR       *"
echo "***************************************************"
echo "\33[1;32m"
