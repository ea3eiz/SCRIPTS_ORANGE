...
mode=`grep -n -m 1 '\<TXInvert\>' ~/MMDVMHost/MMDVMDSTAR.ini`
...
do
        ...
        [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=/dev/ttyAMA0" ~/MMDVMHost/MMDVMDSTAR.ini
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor  actual  del Brightness : \33[1;33m${Brightness1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea Brightness=$V" ~/MMDVMHost/MMDVMDSTAR.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
