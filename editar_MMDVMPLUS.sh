...
ind=`grep -n "Callsign" /home/orangepi/MMDVMHost/MMDVMPLUS.ini`
...
mode=`grep -n -m 1 '\<Modem\>' /home/orangepi/MMDVMHost/MMDVMPLUS.ini`
...
letra=p
linea2=$linea$letra
var99= sed -n $linea2  /home/orangepi/MMDVMHost/MMDVMPLUS.ini;
...
salto=`grep -n -m 1 -c '\<OscOffset\>' /home/orangepi/MMDVMHost/MMDVMPLUS.ini`
if [ $salto = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
salto=`grep -n -m 1 '\<OscOffset\>' /home/orangepi/MMDVMHost/MMDVMPLUS.ini`
...
letra=p
linea2=$linea$letra
var200= sed -n $linea2  /home/orangepi/MMDVMHost/MMDVMPLUS.ini;
...
rxinv=`grep -n '\<RXInvert\>' /home/orangepi/MMDVMHost/MMDVMPLUS.ini`
...
do
			  ...
			  [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=/dev/ttyAMA0" /home/orangepi/MMDVMHost/MMDVMPLUS.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM0" /home/orangepi/MMDVMHost/MMDVMPLUS.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM1" /home/orangepi/MMDVMHost/MMDVMPLUS.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyUSB0" /home/orangepi/MMDVMHost/MMDVMPLUS.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Master: \33[1;33m${master#*=}\33[1;37m"
                    ...
                    letra=c            
linea=$largo$letra
                          sed -i "$linea Address=$master1" /home/orangepi/MMDVMHost/MMDVMPLUS.ini
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor  actual  del  scOffset : \33[1;33m${salto#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea OscOffset=$of1" /home/orangepi/MMDVMHost/MMDVMPLUS.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo -n "Valor  actual  del \33[1;33m${var200#*=}\33[1;37m"
                          var100= sed -n $linea2  /home/orangepi/MMDVMHost/MMDVMPLUS.ini;
                          ...
                          sed -i "$linea4 Enable=$dmrac1" /home/orangepi/MMDVMHost/MMDVMPLUS.ini
			              break;;
			              [nN]* ) echo ""
			              break;;
esac
...
do
           	          ...
           	          read -p 'Pulsa enter para abrir el fichero MMDVMPLUS.ini: ' var2
                              ...
                              case $actualizar in
			[sS]* ) echo ""
                              geany /home/orangepi/MMDVMHost/MMDVMPLUS.ini
			break;;
			[nN]* ) echo ""
			break;;
esac
