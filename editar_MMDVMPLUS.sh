...
ind=`grep -n "Callsign" /home/pi/MMDVMHost/MMDVMPLUS.ini`
...
mode=`grep -n -m 1 '\<Modem\>' /home/pi/MMDVMHost/MMDVMPLUS.ini`
...
salto=`grep -n -m 1 -c '\<OscOffset\>' /home/pi/MMDVMHost/MMDVMPLUS.ini`
if [ $salto = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
salto=`grep -n -m 1 '\<OscOffset\>' /home/pi/MMDVMHost/MMDVMPLUS.ini`
...
letra=p
linea2=$linea$letra
var200= sed -n $linea2  /home/pi/MMDVMHost/MMDVMPLUS.ini;
...
rxinv=`grep -n '\<RXInvert\>' /home/pi/MMDVMHost/MMDVMPLUS.ini`
...
echo "Valor  actual  del  scOffset : \33[1;33m${salto#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea OscOffset=$of1" /home/pi/MMDVMHost/MMDVMPLUS.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo -n "Valor  actual  del \33[1;33m${var200#*=}\33[1;37m"
                          var100= sed -n $linea2  /home/pi/MMDVMHost/MMDVMPLUS.ini;
                          ...
                          sed -i "$linea4 Enable=$dmrac1" /home/pi/MMDVMHost/MMDVMPLUS.ini
			              break;;
			              [nN]* ) echo ""
			              break;;
esac
