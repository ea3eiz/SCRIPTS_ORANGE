...
ind=`grep -n "Callsign" /home/pi/MMDVMHost/MMDVMBM.ini`
...
mode=`grep -n -m 1 '\<Modem\>' /home/pi/MMDVMHost/MMDVMBM.ini`
...
salto=`grep -n -m 1 -c '\<OscOffset\>' /home/pi/MMDVMHost/MMDVMBM.ini`
if [ $salto = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
salto=`grep -n -m 1 '\<OscOffset\>' /home/pi/MMDVMHost/MMDVMBM.ini`
...
letra=p
linea2=$linea$letra
var200= sed -n $linea2  /home/pi/MMDVMHost/MMDVMBM.ini;
...
rxinv=`grep -n '\<RXInvert\>' /home/pi/MMDVMHost/MMDVMBM.ini`
...
echo "Valor  actual  del  scOffset : \33[1;33m${salto#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea OscOffset=$of1" /home/pi/MMDVMHost/MMDVMBM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo -n "Valor  actual  del \33[1;33m${var200#*=}\33[1;37m"
                          var100= sed -n $linea2  /home/pi/MMDVMHost/MMDVMBM.ini;
                          ...
                          sed -i "$linea4 Enable=$dmrac1" /home/pi/MMDVMHost/MMDVMBM.ini
			              break;;
			              [nN]* ) echo ""
			              break;;
esac
