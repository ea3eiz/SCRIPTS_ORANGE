...
ind=`grep -n "Callsign" /home/orangepi/MMDVMHost/MMDVMBM.ini`
...
loca=`grep -n "Locatio" /home/orangepi/MMDVMHost/MMDVMBM.ini`
...
mode=`grep -n -m 1 '\<Modem\>' /home/orangepi/MMDVMHost/MMDVMBM.ini`
...
letra=p
linea2=$linea$letra
var99= sed -n $linea2  /home/orangepi/MMDVMHost/MMDVMBM.ini;
...
salto=`grep -n -m 1 -c '\<OscOffset\>' /home/orangepi/MMDVMHost/MMDVMBM.ini`
if [ $salto = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
salto=`grep -n -m 1 '\<OscOffset\>' /home/orangepi/MMDVMHost/MMDVMBM.ini`
...
letra=p
linea2=$linea$letra
var200= sed -n $linea2  /home/orangepi/MMDVMHost/MMDVMBM.ini;
...
rxinv=`grep -n '\<RXInvert\>' /home/orangepi/MMDVMHost/MMDVMBM.ini`
rxinv1=`expr substr $rxinv 4 30`
echo "$rxinv1"

echo ""
echo "\33[1;36m  28)\33[1;33m Abrir fichero MMDVMBM.ini para hacer cualquier cambio\33[1;33m"
echo "\33[1;36m  29)\33[1;37m Guardar fichero de Configuración Brandmeister Spain\33[1;33m"
echo "\33[1;36m  30)\33[1;32m Recuperar fichero de Configuración Brandmeister Spain\33[1;33m"
echo "\33[1;36m  31)\33[1;37m Guardar fichero de Configuración Brandmeister (1)\33[1;33m"
echo "\33[1;36m  32)\33[1;32m Recuperar fichero de Configuración Brandmeister (1)\33[1;33m"
echo "\33[1;36m  33)\33[1;37m Guardar fichero de Configuración Brandmeister (2)\33[1;33m"
echo "\33[1;36m  34)\33[1;32m Recuperar fichero de Configuración Brandmeister (2)\33[1;33m"
...
echo "Valor de la Ciudad: \33[1;33m${loca#*=}\33[1;37m"
              ...
              sed -i "$linea Location=$loc1" /home/orangepi/MMDVMHost/MMDVMBM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=/dev/ttyAMA0" /home/orangepi/MMDVMHost/MMDVMBM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM0" /home/orangepi/MMDVMHost/MMDVMBM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM1" /home/orangepi/MMDVMHost/MMDVMBM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyUSB0" /home/orangepi/MMDVMHost/MMDVMBM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Master: \33[1;33m${master#*=}\33[1;37m"
                    ...
                    letra=c            
linea=$largo$letra
                          sed -i "$linea Address=$master1" /home/orangepi/MMDVMHost/MMDVMBM.ini
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor  actual  del  scOffset : \33[1;33m${salto#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea OscOffset=$of1" /home/orangepi/MMDVMHost/MMDVMBM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo -n "Valor  actual  del \33[1;33m${var200#*=}\33[1;37m"
                          var100= sed -n $linea2  /home/orangepi/MMDVMHost/MMDVMBM.ini;
                          ...
                          sed -i "$linea4 Enable=$dmrac1" /home/orangepi/MMDVMHost/MMDVMBM.ini
			              break;;
			              [nN]* ) echo ""
			              break;;
esac
...
do
           	          ...
           	          read -p 'Pulsa enter para abrir el fichero MMDVMBM.ini: ' var2
                              actualizar=S 
                              case $actualizar in
			[sS]* ) echo ""
                              geany /home/orangepi/MMDVMHost/MMDVMBM.ini
			break;;
			[nN]* ) echo ""
			break;;
esac
...
do
           	        ...
           	        read -p 'Quieres Guardar fichero de Configuración Brandmeister Spain S/N ' copia   
                        case $copia in
			[sS]* ) echo ""
                        clear
