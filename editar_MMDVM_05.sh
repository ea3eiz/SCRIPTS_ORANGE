...
reflector=`grep -n -m 1 '\<Address\>' /home/pi/MMDVMHost/MMDVM.ini_copia`
...
reflector2=`grep -n -m 1 '\<Address\>' /home/pi/MMDVMHost/MMDVM.ini_copia2`
...
reflector3=`grep -n -m 1 '\<Address\>' /home/pi/MMDVMHost/MMDVM.ini_copia3`
...
do
                        ...
                        sed -i "3c $master1" /home/pi/V30/info_MMDVM.ini
			break;;
			[nN]* ) echo ""
			break;;
esac
