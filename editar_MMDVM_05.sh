...
echo "\33[1;36m   7)\33[0m Puerto para Placa NTH/ZUM pinchado en arduino (ttyACM0)\33[1;33m"
echo "\33[1;36m   8)\33[0m Puerto para Placa NTH/ZUM pinchado en arduino (ttyACM1)\33[1;33m"
...
reflector=`grep -n -m 1 '\<Address\>' ~/MMDVMHost/MMDVM.ini_copia`
...
reflector2=`grep -n -m 1 '\<Address\>' ~/MMDVMHost/MMDVM.ini_copia2`
...
reflector3=`grep -n -m 1 '\<Address\>' ~/MMDVMHost/MMDVM.ini_copia3`
