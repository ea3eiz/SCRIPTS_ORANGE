...
reflector=`grep -n -m 1 '\<Address\>' ~/MMDVMHost/MMDVMPLUS.ini_copia`
...
reflector2=`grep -n -m 1 '\<Address\>' ~/MMDVMHost/MMDVMPLUS.ini_copia2`
...
reflector3=`grep -n -m 1 '\<Address\>' ~/MMDVMHost/MMDVMPLUS.ini_copia3`
...
echo "Valor  actual  del  Display: \33[1;33m${mod#*=}\33[1;37m"
                      read -p 'TFT Serial, HD44780, Nextion, OLED, LCDproc : '  modu1
                          ...
                          case $actualizar in
        [sS]* ) echo ""
                          sed -i "$linea Display=$modu1" ~/MMDVMHost/MMDVMPLUS.ini
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor  actual  del  ScreenLayout: \33[1;33m${mo#*=}\33[1;37m"
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea ScreenLayout=$screen1" ~/MMDVMHost/MMDVMPLUS.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
echo "Valor  actual  del  Brightness: \33[1;33m${m#*=}\33[1;37m"
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea Brightness=$screen1" ~/MMDVMHost/MMDVMPLUS.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                        ...
                        #sed -i "2c $master1" ~/V30/info_MMDVMPLUS.ini
			break;;
			[nN]* ) echo ""
			break;;
esac
...
do
                        ...
                        #sed -i "3c $master1" ~/V30/info_MMDVMPLUS.ini
			break;;
			[nN]* ) echo ""
			break;;
esac
