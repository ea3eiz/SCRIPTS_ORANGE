...
ind=`grep -n "Callsign" /home/pi/MMDVMHost/MMDVM.ini`
...
mode=`grep -n -m 1 '\<Modem\>' /home/pi/MMDVMHost/MMDVM.ini`
...
salto=`grep -n -m 1 -c '\<OscOffset\>' /home/pi/MMDVMHost/MMDVM.ini`
if [ $salto = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
salto=`grep -n -m 1 '\<OscOffset\>' /home/pi/MMDVMHost/MMDVM.ini`
...
letra=p
linea2=$linea$letra
var200= sed -n $linea2  /home/pi/MMDVMHost/MMDVM.ini;
...
rxinv=`grep -n '\<RXInvert\>' /home/pi/MMDVMHost/MMDVM.ini`
rxinv1=`expr substr $rxinv 4 30`
echo "$rxinv1"

echo ""
echo "\33[1;36m  28)\33[1;33m Abrir fichero MMDVM.ini para hacer cualquier cambio\33[1;33m"
echo "\33[1;36m  29)\33[1;37m Guardar fichero de Configuración DMR+\33[1;33m"
echo "\33[1;36m  30)\33[1;32m Recuperar fichero de Configuración DMR+\33[1;33m"
echo "\33[1;36m  31)\33[1;37m Guardar fichero de Configuración Brandmeister\33[1;33m"
echo "\33[1;36m  32)\33[1;32m Recuperar fichero de Configuración Brandmeister\33[1;33m"
echo "\33[1;36m  33)\33[1;37m Guardar otro fichero de Configuración\33[1;33m"
echo "\33[1;36m  34)\33[1;32m Recuperar otro fichero de Configuración\33[1;33m"
...
echo "Valor  actual  del  scOffset : \33[1;33m${salto#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea OscOffset=$of1" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo -n "Valor  actual  del \33[1;33m${var200#*=}\33[1;37m"
                          var100= sed -n $linea2  /home/pi/MMDVMHost/MMDVM.ini;
                          ...
                          sed -i "$linea4 Enable=$dmrac1" /home/pi/MMDVMHost/MMDVM.ini
			              break;;
			              [nN]* ) echo ""
			              break;;
esac
...
do
           	          ...
           	          read -p 'Pulsa enter para abrir el fichero MMDVM.ini: ' var2
                              actualizar=S 
                              case $actualizar in
			[sS]* ) echo ""
...
do
           	        ...
           	        read -p 'Quieres Guardar el fichero de Configuración DMR+? S/N ' copia   
                        case $copia in
			[sS]* ) echo ""
                        clear
...
do
           	        ...
           	        read -p 'Quieres Recuperar el fichero de Configuración DMR+? S/N ' restaurar   
                        case $restaurar in
			[sS]* ) echo ""
                        clear
...
do
           	        ...
           	        read -p 'Quieres Guardar el fichero de Configuración Brandmeister? S/N ' copia   
                        case $copia in
			[sS]* ) echo ""
                        clear
                        echo "<<<<<< Haciendo copia de seguridad >>>>>"
...
do
           	        ...
           	        read -p 'Quieres Recuperar el fichero de Configuración Brandmeister? S/N ' restaurar   
                        case $restaurar in
			[sS]* ) echo ""
                        clear
                        echo "<<<<<< Restaurando copia de seguridad >>>>>"
...
do
           	        ...
           	        read -p 'Quieres Guardar otro fichero de Configuración? S/N ' copia   
                        case $copia in
			[sS]* ) echo ""
                        clear
                        echo "<<<<<< Haciendo copia de seguridad >>>>>"
...
do
           	        ...
           	        read -p 'Quieres Recuperar otro fichero de Configuración? S/N ' restaurar   
                        case $restaurar in
			[sS]* ) echo ""
                        clear
                        echo "<<<<<< Restaurando copia de seguridad >>>>>"
