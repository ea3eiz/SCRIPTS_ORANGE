...
mode=`grep -n -m 1 '\<Modem\>' /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini`
...
letra=p
linea2=$linea$letra
var99= sed -n $linea2  /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini;

echo -n "\33[1;36m  10)\33[0m Modificar ID          - \33[1;33m"
idd=`grep -n "Id=" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini`
idd1=`expr substr $idd 4 30`
echo "$idd1"

echo -n "\33[1;36m  11)\33[0m Modificar Address     - \33[1;33m"
master=`grep -n -m 1 '\<Address\>' /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini`
buscar=":"
...
letra=p
linea2=$linea$letra
var200= sed -n $linea2  /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini;

echo -n "\33[1;36m  23)\33[0m Coordenada Latitud    - \33[1;33m"
lat=`grep -n "Latitude" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini`
lat1=`expr substr $lat 4 30`
echo "$lat1"

echo -n "\33[1;36m  24)\33[0m Coordenada Longitud   - \33[1;33m"
long=`grep -n "Longitude" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini`
long1=`expr substr $long 4 30`
echo "$long1"

echo -n "\33[1;36m  25)\33[0m Modificar RXInvert    - \33[1;33m"
rxinv=`grep -n '\<RXInvert\>' /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini`
rxinv1=`expr substr $rxinv 4 30`
echo "$rxinv1"

echo ""
echo "\33[1;36m  26)\33[1;33m Abrir fichero MMDVMLIBRE.ini para hacer cualquier cambio\33[1;33m"
echo "\33[1;36m  27)\33[1;37m Guardar fichero de Configuración placa NTH\33[1;33m"
echo "\33[1;36m  28)\33[1;32m Recuperar fichero de Configuración placa NTH\33[1;33m"
echo "\33[1;36m  29)\33[1;37m Guardar fichero de Configuración DVMEGA\33[1;33m"
echo "\33[1;36m  30)\33[1;32m Recuperar fichero de Configuración DVMEGA\33[1;33m"
echo ""
echo "\33[1;36m   0)\33[1;34m Salir del script \33[1;31m OJO!! no salir con ctrl+c ni con la x"
echo ""
echo -n "\33[1;36m   Elige una opción del 0 al 30: " 
read escoger_menu
...
echo "Valor actual Indicativo: \33[1;33m${ind#*=}\33[1;37m"
           	          read -p 'Introduce tu indicativo: ' indicativo
                          ...
                          sed -i "$linea Callsign=$indicativo" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del RXFrequency: \33[1;33m${rxf#*=}\33[1;37m"
           	          ...
           	          read -p 'Introduce RXFrequency:        ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                              sed -i "$linea RXFrequency=$var2" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			break;;
			[nN]* ) echo ""
			break;;
esac
...
echo "Valor actual del TXFrequency: \33[1;33m${txf#*=}\33[1;37m"
           	          ...
           	          read -p 'Introduce TXFrequency:        ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXFrequency=$var2" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de la Ciudad: \33[1;33m${loca#*=}\33[1;37m"
              ...
              sed -i "$linea Location=$loc1" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de  la  URL   Web: \33[1;33m${url#*=}\33[1;37m"
			  ...
			  ur1=`echo "$ur1" | tr -d '[[:space:]]'`
                          sed -i "$linea URL=$ur1" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=/dev/ttyAMA0" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM0" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM1" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyUSB0" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del Id: \33[1;33m${idd#*=}\33[1;37m"
           	          read -p 'Introduce un ID válido ' miid
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Id=$miid" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Master: \33[1;33m${master#*=}\33[1;37m"
                    ...
                    letra=c            
linea=$largo$letra
                          sed -i "$linea Address=$master1" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=$miid" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Password: \33[1;33m${pas#*=}\33[1;37m"
           	          read -p 'Password para Brandmeister=passw0rd para DMR+=PASSWORD: ' pas1
                          letra=c
                          if [ $largo = 3 ]
                          then
                          ...
                          sed -i "$linea Password=$pas1" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual del  TXInvert: \33[1;33m${txinv#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXInvert=$txinv1" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  RXLevel : \33[1;33m${rx#*=}\33[1;37m"
           	          read -p 'Valor óptimo para DVMEGA=45 : ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea RXLevel=$var2" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  TXLevel : \33[1;33m${tx#*=}\33[1;37m"
           	          read -p 'Valor óptimo para DVMEGA=50 : ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXLevel=$var2" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Duplex: \33[1;33m${dup#*=}\33[1;37m"
           	          read -p 'Para un repetidor Duplex=1 Para un DVMEGA Duplex=0: ' dup1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Duplex=$dup1" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del DisplayLevel: \33[1;33m${lg#*=}\33[1;37m"
           	     read -p 'Para visualizar tramas seguidas introduce 1, para una sola trama introduce 2:' lg1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea DisplayLevel=$lg1" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
sl=`grep -n -m 1 -c '\<Slot1\>' /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini`
if [ $sl = 0 ]; then
...
echo "Valor actual del Slot1=: \33[1;33m${sl#*=}\33[1;37m"
           	          read -p 'Para DVMEGA Modificar el valor del Slot1=0: ' V
			              ...
			              [sS]* ) echo ""
			              V=`echo "$V" | tr -d '[[:space:]]'`			  
                          sed -i "$linea Slot1=$V" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
...
echo "Valor  actual  del  scOffset : \33[1;33m${salto#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea OscOffset=$of1" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  Module: \33[1;33m${modu#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Module=$modu1" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo -n "Valor  actual  del \33[1;33m${var200#*=}\33[1;37m"
                          var100= sed -n $linea2  /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini;
                          ...
                          sed -i "$linea4 Enable=$dmrac1" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			              break;;
			              [nN]* ) echo ""
			              break;;
esac
...
echo "Valor de la Latitud: \33[1;33m${lat#*=}\33[1;37m"
           	          read -p 'Introduce la Latitud ' lat1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Latitude=$lat1" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de la Longitud: \33[1;33m${long#*=}\33[1;37m"
           	          read -p 'Introduce la Longitud ' long1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Longitude=$long1" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual del  RXInvert: \33[1;33m${rxinv#*=}\33[1;37m"
                      read -p 'Valor óptimo para Motorola=0 para otras=1 : ' rxinv11
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
        [sS]* ) echo ""
                          sed -i "$linea RXInvert=$rxinv11" /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
        break;;
        [nN]* ) echo ""
        break;;
esac
...
do
           	          ...
           	          read -p 'Pulsa enter para abrir el fichero MMDVMLIBRE.ini: ' var2
                              actualizar=S 
                              case $actualizar in
			[sS]* ) echo ""
                              geany /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
			break;;
			[nN]* ) echo ""
			break;;
esac
...
do
                    ...
                    read -p 'Quieres Guardar el fichero de Configuración placa HTH ? S/N ' copia   
                        case $copia in
      [sS]* ) echo ""
                        clear
                        echo "<<<<<< Haciendo copia de seguridad >>>>>"
                        sleep 3
                        sudo cp -f /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini_NTH
      break;;
      [nN]* ) echo ""
      break;;
esac
...
do
                    ...
                    read -p 'Quieres Recuperar el fichero de Configuración placa NTH ? S/N ' restaurar   
                        case $restaurar in
      [sS]* ) echo ""
                        clear
                        echo "<<<<<< Restaurando copia de seguridad >>>>>"
                        sleep 3
                        sudo cp -f /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini_NTH /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
      break;;
      [nN]* ) echo ""
      break;;
esac
...
do
                    ...
                    read -p 'Quieres Guardar el fichero de Configuración DVMEGA ? S/N ' copia   
                        case $copia in
      [sS]* ) echo ""
                        clear
                        echo "<<<<<< Haciendo copia de seguridad >>>>>"
                        sleep 3
                        sudo cp -f /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini_DVMEGA
      break;;
      [nN]* ) echo ""
      break;;
esac
...
do
                    ...
                    read -p 'Quieres Recuperar el fichero de Configuración DVMEGA ? S/N ' restaurar   
                        case $restaurar in
      [sS]* ) echo ""
                        clear
                        echo "<<<<<< Restaurando copia de seguridad >>>>>"
                        sleep 3
                        sudo cp -f /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini_DVMEGA /home/pi/MMDVMHostLIBRE/MMDVMLIBRE.ini
      break;;
      [nN]* ) echo ""
      break;;
esac
